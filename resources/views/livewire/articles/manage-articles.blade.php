<div class="p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Manage Articles</h2>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-4">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="space-x-2">
                        <button wire:click="edit({{ $article->id }})" class="text-blue-500 hover:text-blue-700">Edit</button>
                        <button wire:click="delete({{ $article->id }})" class="text-red-500 hover:text-red-700">Delete</button>
                    </div>
                </div>
            </div>
        </div>
